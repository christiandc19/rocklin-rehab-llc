  ...
  return (
    <>
      <div className="mh-cards-header container">
        <h1>
          ROCKLIN REHAB TREATMENT CENTER OFFERS VARIOUS MENTAL HEALTH PROGRAMS{" "}
        </h1>
        <p>
          At Rocklin Rehab Treatment Center, clients receive individual therapy
        ...
        <div class="mh-tile">
          ...
          <div class="mh-text">
            ...
            <p class="mh-animate-text">
              ...
              are dealing with, there’s something for everyone at Rocklin Rehab.
            </p>
            <div class="mh-animate-text">
              <LinkRoll
                activeClass="active"
