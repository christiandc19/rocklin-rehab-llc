    ...
    <div class="contact-form-content">
      ...
      <div class="left-side">
        ...
        <div class="address details">
          ...
          <div class="text-one">4960 Rocklin Road, Suite 200r,</div>
          <div class="text-two">Rocklin CA 95677</div>
        </div>

        <div class="phone details">
          <i class="fas fa-phone-alt"></i>
          <div class="topic">Phone</div><br/>
          <div class="text-one"><a href="tel:3234195733"> +1 (323) 419-5733</a></div>
        </div>
