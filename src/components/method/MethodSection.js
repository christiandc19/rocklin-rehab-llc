  ...
  return (
    <>
      ...
      <div className="container treatment-section-overview">
        ...
        <p>
          Here at Rocklin Rehab, we firmly stand that without addressing our
          ...
          <br />
          <br />
          Methods used by Rocklin Rehab are non-invasive, distinct, and
      ...
      <div className="treatment-section-activities">
        <div className="treatment-left">
          ...
          <p>
            Rocklin Rehab Rehab promotes fun activities that clients learn how
            to develop interests and hobbies that helps then improve their
            mental health. Clients must be cleared by the doctor to participate.
